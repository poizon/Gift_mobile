...
var nicUploadButton = nicEditorAdvancedButton.extend({	
  ...
  onUploaded : function(options) {
	...
	// modify by pavel kuptsov
	height : (w && options.image.height) ? Math.min(w, options.image.height) : ''
      });
    }
  }
});
...
var nicCodeButton = nicEditorAdvancedButton.extend({
	...
	addPane : function() {
		this.addForm({
			...
			'code' : {type : 'content', 'value' : this.ne.selectedInstance.getContent(), style : {width: '640px', height : '400px'}}
		});
	},
